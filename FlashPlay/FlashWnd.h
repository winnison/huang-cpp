...
OLECONTAINER(HRESULT STDMETHODCALLTYPE)::SetCapture(/* [in] */ BOOL fCapture)
{
	return S_FALSE;
}	 
...
OLECONTAINER(HRESULT STDMETHODCALLTYPE)::SetFocus(/* [in] */ BOOL fFocus)
{
