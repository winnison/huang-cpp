...
//Motion
public:
	enum MotionType{Nomotion = 0, DisappearingMotion = 1, ShakeMotion = 2, SnowMotion = 3, BluringMotion = 4, CircinateMotion = 5, SizingMotion = 6, HTurnOverMotion = 7, VTurnOverMotion = 8, RollingMotion = 9, WobblyMotion = 10, JumperMotion = 11};
